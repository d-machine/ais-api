...
CREATE OR REPLACE FUNCTION administration.delete_user_role(
    user_role_id_to_delete INTEGER,
...
BEGIN
    ...
    WHERE id = user_role_id_to_delete;

    -- Delete the user_role
    DELETE FROM administration.user_role WHERE id = user_role_id_to_delete;
END;
$$ LANGUAGE plpgsql; 