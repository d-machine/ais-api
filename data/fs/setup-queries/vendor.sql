CREATE TABLE IF NOT EXISTS wms.vendor (
...
DROP TRIGGER IF EXISTS vendor_delete_trigger ON wms.vendor;
CREATE TRIGGER vendor_delete_trigger
AFTER DELETE ON wms.vendor
FOR EACH ROW
EXECUTE FUNCTION wms.vendor_trigger();
