...
BEGIN
  IF (TG_OP = 'INSERT') THEN
    INSERT INTO wms.item_category_history (category_id, name, descr, is_active, operation, operation_at, operation_by)
...
CREATE TRIGGER item_category_insert_trigger
    AFTER INSERT ON wms.item_category
    FOR EACH ROW
